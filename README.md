...
endpoint and a PATCH /{id}/status endpoint for toggling availability. Verified live: all of the above
work as coded. service/BookService.getBookById and deleteBook: both correctly use
